...
par(mfrow = c(2, 2)) 
plot(epc_datetime, epc_subset$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)
plot(epc_datetime, epc_subset$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(epc_datetime, epc_subset$Global_active_power, type="l", xlab="datetime", ylab="Global_reactive_power")
